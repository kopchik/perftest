...
#ifndef _SVM_COMMON_H
#define _SVM_COMMON_H
...
# define FNUM    unsigned long        /* the type used for storing feature ids */
...
typedef struct forest{
	...
	OrderedTreeNode		*orderedNodeSet;  /* Contain the ordered (by production) node list */
//	OrderedTreeNode		*orderedNodeSetbyLevel;	/* ordered (by node level) node list */
...
extern void my_read_examples(char *inputfile, DOC **X, double **Y, long *totdoc, KERNEL_PARM kernel_parm);

extern double productions_kernel(DOC * a, DOC * b);
